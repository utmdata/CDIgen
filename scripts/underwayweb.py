...
def underway_general(cruise_id, cruise_name, date_inicial, date_final, vessel_input, data, valor_org, csr_code):
    ...
    input_url = f"https://datahub.utm.csic.es/ws/getTrack/GML/?id={vessel_input}{cruise_id[4:12]}&n=999"
    ...
    # Add Bounding Box
    url_bbox = f"https://datahub.utm.csic.es/ws/getBBox/?id={vessel_input}{cruise_id[4:12]}"
