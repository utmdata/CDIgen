...
def funcio_tra (cruise_id, cruise_name, vessel_input, ruta_csv, date_inicial, date_final):
    cdi_model = "_tra"
    ...
    cdi_global=cruise_id + "/" + cruise_id + "_tra.xml"
...
>>>>>>> main
    ...
    if path.exists(cruise_id + "_tra.txt"):
      remove(cruise_id + "_tra.txt")

    #canviar segons el cdi:   

<<<<<<< HEAD
    select_instrument = "TRAMPA SEDIMENTO"
=======
    select_instrument = "TRA"
>>>>>>> main
...
>>>>>>> main
    ...
    for i in range(0,total_lines):
      ...
      name3= "Data from sediment traps deployed and acquired on board the R/V  "+ vessel +" during the " + cruise_name +" cruise." #canviar  
      fila=fila+1
...
<<<<<<< HEAD
    posList.text = cruise_name + " sediment trap data"
=======
    posList.text = cruise_name + " sediment traps"
>>>>>>> main
    tree.write(cdi_global)
...
<<<<<<< HEAD
    posList.text = "Data from " + str(total_lines) +  " sediment traps deployed and acquired on board the R/V "+ vessel +" during the " + cruise_name +" cruise."
=======
    posList.text = "Data from sediment traps deployed and acquired on board the R/V "+ vessel +" during the " + cruise_name +" cruise."
>>>>>>> main
    tree.write(cdi_global)
    print(total_lines)
