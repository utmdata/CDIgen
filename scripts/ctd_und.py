...
def funcio_ctd_und (cruise_id, cruise_name, vessel_input, ruta_csv, date_inicial, date_final):
    cdi_model = "_ctd_und"
    ...
    posList_1.text =  'CTD undulators'
    posList_1.set ("codeListValue","131")
...
#<a href="http://data.utm.csic.es/geonetwork/srv/eng/catalog.search#/metadata/urn:SDN:CDI:LOCAL:29SG20230719_ctd_ros_ladcp"  target="_blank">View in metadata catalog</a>
  ...
  #afegir dataset id (ho fem tres cops perque s'ha de canviar tres vegades)
    ...
    posList.text = "Water column data from "+ str(total_lines) +  " " + text + "acquired on board the R/V " + vessel + " with a SeaSoar towed CTD during the " + cruise_name + " cruise."
